            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-white font-medium">Toll Free - +91 99533 30277</p>
                    <p className="text-xs text-slate-500 mt-1">9:30 AM to 6:30 PM (Mon-Sun)</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <Mail className="w-5 h-5 text-blue-500 shrink-0" />
                  <a href="mailto:feedback@vasturealty.com" className="hover:text-blue-400 transition-colors">prabhat58236@gmail.com</a>
                </div>
              </div>
              ...
              <div className="pt-4">
                ...
                <div className="flex gap-4">
                  ...
                  <a href="https://www.instagram.com/realty.vastu33/" target="_blank" className="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-pink-600 transition-colors group">
