...
import { Building2, MapPin, Calendar, ChevronLeft } from 'lucide-react'
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="pt-24 pb-16 px-5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-black text-[#0A1128]">All Construction Projects</h1>
            <p className="text-slate-500 mt-2">{constructionProjects.length} projects available</p>
          </div>
                  ...
                  <div className="flex-1 p-6">
                    <div className="flex flex-col h-full justify-between">
                      ...
                      <div className="mt-4 flex justify-end">
                        <span className="px-6 py-2.5 bg-slate-50 text-[#0A1128] rounded-lg font-bold text-sm hover:bg-green-600 hover:text-white transition-all">
                          View Details →
                        </span>
                      </div>
                    </div>
